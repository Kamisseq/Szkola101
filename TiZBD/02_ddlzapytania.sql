...
ALTER TABLE student
MODIFY nazwisko VARCHAR(250) NOT NULL,
ADD UNIQUE (nr_indeksu),
ADD CONSTRAINT ch_stypendium CHECK (stypendium >= 1000.00);
 
-- B. Dodaj niepustą kolumnę imie (powinna znaleźć się za polem nazwisko).
ALTER TABLE student
ADD imie VARCHAR(250) NOT NULL AFTER nazwisko;
...
ALTER TABLE student
ALTER stypendium SET DEFAULT 1000.00;
